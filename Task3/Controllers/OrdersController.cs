...
namespace Task3.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public OrdersController(BISContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("O_ID,P_Name,Quantity,CAddress")] Order order)
        {
            if (id != order.O_ID)
            {
                return NotFound();
        ...
        {
            return _context.Order.Any(e => e.O_ID == id);
        }
    }
}
